...
class DownloadWebPageContent(ManifestBase):
    ...
    def implemented_manifest_differ_from_this_manifest(self, manifest_lookup_function: object=dummy_manifest_lookup_function, variable_cache: VariableCache=VariableCache(), value_placeholders: ValuePlaceHolders=ValuePlaceHolders())->bool:
    ...
    def apply_manifest(self, manifest_lookup_function: object=dummy_manifest_lookup_function, variable_cache: VariableCache=VariableCache(), increment_exec_counter: bool=False, value_placeholders: ValuePlaceHolders=ValuePlaceHolders()):
    ...
    def delete_manifest(self, manifest_lookup_function: object=dummy_manifest_lookup_function, variable_cache: VariableCache=VariableCache(), increment_exec_counter: bool=False, value_placeholders: ValuePlaceHolders=ValuePlaceHolders()):
